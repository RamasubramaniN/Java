...
public class Mail {
    ...
    private final String _USERNAME = "rms.ece";
    private final String _PASSWORD = "tamilselvi";
	...
	public static void main(String[] args) throws MessagingException {
       ...
       // sending mail, without attachment.
        sender.send("rms.ece@gmail.com","areykarthi@gmail.com", "Hi, this is generated through java code" , "this is a h1 tag so, it may appears in huge size! :D");

       // sending another mail, with 2 attachments.
        
        attachments.add("C://Users/ramasubramanin/Desktop/c.doc");

       sender.send("rms.ece@gmail.com","areykarthi@gmail.com", "Hi Ramasubramani,\n\t This is my java mail with attachments" ,"this is a h1 tag so, it may appears in huge size! :D", attachments);
	...
	private void send(String from, String to, String subject, String body) throws MessagingException {
		...
		Session session = Session.getDefaultInstance(props,
			...
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("rms.ece", s);
			}
		});
